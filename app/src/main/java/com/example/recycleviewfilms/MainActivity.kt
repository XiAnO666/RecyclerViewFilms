...
class MainActivity : AppCompatActivity() {
    ...
    private fun getMovies(): List<Films> {
        ...
        val request = Request.Builder()
            ...
            .addHeader("Authorization", "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIzNjZjNGExYmQ3YjY5NGFmNGRlMDBhYmIxMDY1NDM1YiIsInN1YiI6IjYzODRmMTZmNTM4NjZlMDA3YjA5NmQxMSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.2cCMmZykjCH6dabKYih3aFtU8Jd33zragpeCAmdCnpk")
            .build()
        ...
        for (i in 0 until jsonArray.length()){
            ...
            val posterPath = "https://image.tmdb.org/t/p/w300_and_h450_bestv2/" + filmObject.getString("poster_path")
